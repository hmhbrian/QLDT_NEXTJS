/**
 * LEGACY API Services
 * ⚠️ DEPRECATED: These are legacy APIs for backward compatibility only.
 * For new code, please use the modern services from '../services' or '../core'
 * 
 * This file exports legacy API services and configuration
 */
