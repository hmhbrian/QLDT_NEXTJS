...
export const mockUsers: User[] = [
    ...
    },
    {
        ...
        completedCourses: [
            { courseId: 'C1', courseName: 'JavaScript Fundamentals', completionDate: '2024-02-15', grade: 85, feedback: 'Good understanding' },
            { courseId: 'C2', courseName: 'React Basics', completionDate: '2024-03-01', grade: 90, feedback: 'Excellent work' }
        ],
        certificates: [{ id: 'CERT1', name: 'JS Developer', issueDate: '2024-02-20', issuingOrganization: 'Tech Academy', credentialId: 'JS-2024-001' }],
        evaluations: [{ id: 'E1', evaluator: 'HR Manager', evaluationDate: '2024-03-15', type: 'monthly', criteria: [], overallScore: 4, status: 'approved' }]
    },
...
export const mockTrainee: Trainee = { // Trainee type might need review if User is comprehensive
