import type { Course, Lesson, Test, Question } from "../types";
        ...
        questions: [
          {
            ...
            correctAnswerIndex: 0,
            explanation:
              "PMP (Project Management Professional) là chứng chỉ quản lý dự án được công nhận trên toàn cầu, do Viện Quản lý Dự án (PMI) cấp.",
          },
          {
            id: "qpm2",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Tam giác ràng buộc (Triple Constraint) trong quản lý dự án bao gồm Chi phí (Cost), Thời gian (Time) và Phạm vi (Scope). Khi một yếu tố thay đổi, các yếu tố khác cũng bị ảnh hưởng.",
          },
          {
            id: "qpm3",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Phương pháp Agile phù hợp với các dự án có yêu cầu thay đổi thường xuyên và cần phản hồi nhanh chóng, như phát triển phần mềm. Agile tập trung vào việc linh hoạt, thích ứng và cung cấp giá trị sớm.",
          },
          {
            id: "qpm4",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Biểu đồ Gantt là công cụ trực quan để lập kế hoạch dự án, hiển thị các nhiệm vụ, thời gian bắt đầu và kết thúc, cũng như mối quan hệ giữa các nhiệm vụ theo dòng thời gian.",
          },
          {
            id: "qpm5",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Quản lý rủi ro bao gồm việc nhận diện các rủi ro tiềm ẩn, phân tích mức độ ảnh hưởng và khả năng xảy ra, lập kế hoạch ứng phó, và giám sát rủi ro trong suốt vòng đời dự án.",
          },
        ],
        ...
        questions: [
          {
            ...
            correctAnswerIndex: 0,
            explanation:
              "Phương pháp đường găng (Critical Path Method - CPM) xác định chuỗi các hoạt động có tổng thời gian dài nhất, quyết định thời gian tối thiểu cần thiết để hoàn thành dự án.",
          },
          {
            id: "qpm7",
            ...
            correctAnswerIndex: 0,
            explanation:
              "PERT (Program Evaluation and Review Technique) là kỹ thuật phân tích dùng để lập kế hoạch và kiểm soát dự án, đặc biệt hữu ích khi thời gian thực hiện các công việc không chắc chắn.",
          },
          {
            id: "qpm8",
            ...
            correctAnswerIndex: 0,
            explanation:
              "EVM (Earned Value Management) là phương pháp quản lý giá trị thu được, giúp đo lường hiệu suất chi phí và tiến độ của dự án, so sánh công việc đã hoàn thành với kế hoạch ban đầu.",
          },
          {
            id: "qpm9",
            ...
            correctAnswerIndex: 0,
            explanation:
              "WBS (Work Breakdown Structure) là cấu trúc phân chia công việc, một công cụ phân tích phạm vi dự án bằng cách chia nhỏ công việc thành các gói công việc có thể quản lý được.",
          },
          {
            id: "qpm10",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Các bên liên quan (stakeholders) bao gồm tất cả những ai có thể ảnh hưởng hoặc bị ảnh hưởng bởi dự án, như nhóm dự án, khách hàng, nhà tài trợ, người dùng cuối, nhà cung cấp, v.v.",
          },
        ],
        passingScorePercentage: 70,
      },
        ...
        questions: [
          {
            ...
            correctAnswerIndex: 0,
            explanation:
              "Nguyên tắc gần nhau (Proximity) trong thiết kế UI/UX cho rằng các phần tử liên quan đến nhau nên được đặt gần nhau, tạo sự liên kết trực quan và giúp người dùng hiểu được mối quan hệ giữa các phần tử.",
          },
          {
            id: "quiux2",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Định luật Hick (Hick's Law) phát biểu rằng thời gian cần thiết để đưa ra quyết định tăng theo logarit của số lượng lựa chọn. Điều này giải thích tại sao giao diện đơn giản, ít lựa chọn thường dễ sử dụng hơn.",
          },
          {
            id: "quiux3",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Affordance là các thuộc tính của một đối tượng cho người dùng biết cách họ có thể tương tác với nó. Ví dụ, nút có hình dạng và bóng đổ gợi ý rằng nó có thể được nhấn.",
          },
          {
            id: "quiux4",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Nguyên tắc tối giản (Minimalism) tập trung vào việc loại bỏ các yếu tố không cần thiết và giữ lại những gì thực sự quan trọng. Điều này giúp giảm nhiễu thông tin và cải thiện trải nghiệm người dùng.",
          },
          {
            id: "quiux5",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Bản phác thảo độ trung thành thấp (low-fidelity wireframe) thường được sử dụng trong giai đoạn đầu của quá trình thiết kế để khám phá và truyền đạt ý tưởng về bố cục, cấu trúc và luồng thông tin, mà không tập trung vào chi tiết thẩm mỹ.",
          },
        ],
        passingScorePercentage: 70,
      },
        ...
        questions: [
          {
            ...
            correctAnswerIndex: 0,
            explanation:
              "Thiết kế bao gồm (Inclusive Design) là phương pháp thiết kế tập trung vào việc tạo ra sản phẩm và dịch vụ có thể tiếp cận được với nhiều người nhất có thể, bao gồm cả người khuyết tật và người có nhu cầu đặc biệt.",
          },
          {
            id: "quiux7",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Information Architecture (Kiến trúc thông tin) liên quan đến việc tổ chức, cấu trúc và gắn nhãn nội dung trong hệ thống để giúp người dùng tìm kiếm thông tin và hoàn thành nhiệm vụ dễ dàng hơn.",
          },
          {
            id: "quiux8",
            ...
            correctAnswerIndex: 0,
            explanation:
              "A/B Testing là phương pháp so sánh hai phiên bản của một trang web hoặc ứng dụng để xác định phiên bản nào tạo ra kết quả tốt hơn dựa trên các chỉ số quan trọng như tỷ lệ chuyển đổi hoặc thời gian sử dụng.",
          },
          {
            id: "quiux9",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Dark patterns là các kỹ thuật thiết kế giao diện người dùng được thiết kế để đánh lừa hoặc thao túng người dùng làm những việc họ không có ý định làm, như đăng ký dịch vụ trả phí hoặc chia sẻ thông tin cá nhân.",
          },
          {
            id: "quiux10",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Progressive Disclosure (Tiết lộ tiến bộ) là kỹ thuật thiết kế giúp quản lý độ phức tạp của giao diện bằng cách chỉ hiển thị thông tin và chức năng cần thiết tại thời điểm đó, giảm quá tải thông tin cho người dùng.",
          },
        ],
        ...
        questions: [
          {
            ...
            correctAnswerIndex: 0,
            explanation:
              "Pandas là thư viện Python phổ biến nhất cho việc xử lý và phân tích dữ liệu dạng bảng. Nó cung cấp các cấu trúc dữ liệu mạnh mẽ như DataFrame và Series.",
          },
          {
            id: "qpyds2",
            ...
            correctAnswerIndex: 0,
            explanation:
              "NumPy array được tối ưu hóa cho các phép tính số học, có hiệu suất cao hơn và chiếm ít bộ nhớ hơn so với Python list thông thường, đặc biệt khi làm việc với dữ liệu lớn.",
          },
          {
            id: "qpyds3",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Matplotlib là thư viện trực quan hóa cơ bản trong Python, trong khi Seaborn xây dựng trên Matplotlib và cung cấp giao diện cấp cao hơn với các biểu đồ thống kê mặc định đẹp mắt.",
          },
          {
            id: "qpyds4",
            ...
            correctAnswerIndex: 0,
            explanation:
              "pd.read_csv() là hàm Pandas dùng để đọc dữ liệu từ tệp CSV vào DataFrame. Hàm này có nhiều tham số để tùy chỉnh cách đọc dữ liệu.",
          },
          {
            id: "qpyds5",
            ...
            correctAnswerIndex: 0,
            explanation:
              "train_test_split() là hàm từ module model_selection của Scikit-learn, dùng để chia tập dữ liệu thành các phần riêng biệt để huấn luyện và kiểm tra mô hình học máy.",
          },
        ],
        passingScorePercentage: 80,
      },
        ...
        questions: [
          {
            ...
            correctAnswerIndex: 0,
            explanation:
              "Imputation là kỹ thuật thay thế giá trị bị thiếu bằng các giá trị ước tính như giá trị trung bình, trung vị hoặc giá trị phổ biến nhất của cột. Đây là phương pháp phổ biến để xử lý missing values trong khoa học dữ liệu.",
          },
          {
            id: "qpyds7",
            ...
            correctAnswerIndex: 0,
            explanation:
              "One-hot encoding là kỹ thuật chuyển đổi biến phân loại thành các véc-tơ nhị phân. Mỗi giá trị phân loại được biểu diễn bằng một cột mới, với giá trị 1 nếu dữ liệu thuộc danh mục đó và 0 nếu không thuộc.",
          },
          {
            id: "qpyds8",
            ...
            correctAnswerIndex: 0,
            explanation:
              'GridSearchCV là một kỹ thuật trong scikit-learn để tự động tìm kiếm tham số tối ưu cho mô hình học máy bằng cách thử tất cả các tổ hợp tham số có thể trong một "lưới" các giá trị đã xác định trước.',
          },
          {
            id: "qpyds9",
            ...
            correctAnswerIndex: 0,
            explanation:
              "ROC (Receiver Operating Characteristic) curve và AUC (Area Under the Curve) là các phương pháp phổ biến để đánh giá hiệu suất của mô hình phân loại nhị phân, cho phép trực quan hóa và định lượng khả năng phân biệt của mô hình ở các ngưỡng khác nhau.",
          },
          {
            id: "qpyds10",
            ...
            correctAnswerIndex: 0,
            explanation:
              "Pipeline trong scikit-learn là một cách để kết hợp nhiều bước xử lý dữ liệu (như scaling, PCA) và mô hình học máy thành một quy trình duy nhất, giúp tránh rò rỉ dữ liệu và đơn giản hóa code.",
          },
        ],
        passingScorePercentage: 75,
      },
  ...
  syllabus: [
    {
      ...
      content:
        "Tổng quan về khóa học. Cài đặt môi trường. Các khái niệm cơ bản của JS. Giới thiệu về let, const, arrow functions, template literals, default parameters, rest/spread operators.",
      duration: "2 tuần",
    },
    {
      title: "Tuần 3-4: Lập trình Hướng đối tượng (OOP) với Classes & Modules",
      content:
        "Classes, constructors, inheritance, static methods, getters/setters. JavaScript Modules: import/export.",
      duration: "2 tuần",
    },
    {
      title: "Tuần 5-6: Xử lý Bất đồng bộ",
      content:
        "Callbacks, Promises (then, catch, finally, Promise.all, Promise.race), Async/Await.",
      duration: "2 tuần",
    },
  ],
  slides: [
